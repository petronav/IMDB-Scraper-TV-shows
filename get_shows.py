...
def main():
	...
	if r.status_code == 200:
		...
		shows_all_details = {k : get_show_details(v) for k,v in shows_links_title_dict.items()}
		print(shows_all_details)
		r = json.dumps(shows_all_details, indent=4)
		f = open('AllShows.json', 'w')
		f.write(r)
		f.close()
